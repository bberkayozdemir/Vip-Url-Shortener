...
<html>
    <head>
        <title>Vip Url Shortener Installation Wizard</title>
        ...
        <div class="main">
            ...
            <div class="main-agilerow"> 
                ...
                <div class="ci-form-wrap" id="success-wrap" style="display:none;">
					...
					<p><b>Please delete the "install" folder.</b></p>
                    <hr />
                    
                    <p><a class="btn btn-primary" href="<?php echo $base_url; ?>/login">Click Here</a><strong> to Login!</strong></p>
                ...
                <div class="ci-form-wrap" id="main-wrap">
                    <form action="#" method="post">
                        ...
                        <div class="form-step1"> 						
                            <span class="hints">Ex - https://example.com/</span>
