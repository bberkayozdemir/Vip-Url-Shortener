...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom" style="display:block !important">
    <div class="row">
        <div class="col-lg-9 marauto">
            <h1 class="h2">Url View<?php if ($url_data->description !== null){ echo " - ".$url_data->description; } ?></h1>   
        </div>
        <div class="col-lg-3">
    ...
    <div class="col-lg-9 marbot20">
        ...
        <div class="card border-light ">
            ...
            <div class="card-body" style="height:200px">
                ...
                <div class="no_data" style="padding-top:60px">NO DATA AVAIBLE</div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 url-view-table-col" id="location_data_col">
                        ...
                        <div class="no_data" style="padding-top:123px">NO DATA AVAIBLE</div>
                    </div>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
            url: '<?=base_url()?>admin/get_chart_data/' + time + "/" + url_id,
            contentType: false,
            processData: false,
